...
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(14475748);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(14476916);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(14478964);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(14479636);
}
}
if (isConditionTrue_0) {
...
{for(var i = 0, len = gdjs.LevelCode.GDEndScreenSubHeaderObjects4.length ;i < len;++i) {
    gdjs.LevelCode.GDEndScreenSubHeaderObjects4[i].getBehavior("Text").setText("Ты собрал " + gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().getFromIndex(0)) + " очков!");
}
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(14501676);
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(14498740);
}
}
if (isConditionTrue_0) {
...
{for(var i = 0, len = gdjs.LevelCode.GDBackgroundPlantsObjects2.length ;i < len;++i) {
    gdjs.LevelCode.GDBackgroundPlantsObjects2[i].getBehavior("Resizable").setWidth(gdjs.evtTools.camera.getCameraWidth(runtimeScene, "", 0));
}
}{for(var i = 0, len = gdjs.LevelCode.GDBackgroundPlantsObjects2.length ;i < len;++i) {
    ...
    gdjs.LevelCode.GDCloudsObjects2[i].getBehavior("Resizable").setWidth(gdjs.evtTools.camera.getCameraWidth(runtimeScene, "", 0));
}
}{for(var i = 0, len = gdjs.LevelCode.GDCloudsObjects2.length ;i < len;++i) {
